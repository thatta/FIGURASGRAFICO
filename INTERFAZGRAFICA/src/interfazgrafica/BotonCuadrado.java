...
public class BotonCuadrado extends JPanel implements ActionListener{
    ...
    private VentanaCuadrado principal;
     ...
     * @param principal
     */
    public BotonCuadrado(VentanaCuadrado principal){
        ...
        Puntos puntoD = new Puntos(0, 4);
               
        puntoA = new Puntos(0, 0);
        puntoB = new Puntos(4, 0);
        puntoC = new Puntos(4, 4);
        puntoD =new Puntos(0,4);
        areayperimetro = new Cuadrado(puntoC, puntoD, puntoA,puntoB);
    ...
    public void pidePuntos(){
        ...
        x4=JOptionPane.showInputDialog(botonPunto,"Digite coordenada x4");
        b4 = Double.parseDouble(x4);
        y4=JOptionPane.showInputDialog(botonPunto,"Digite coordenada y4");
        b4 = Double.parseDouble(y4);
        
       Puntos puntoA = new Puntos(a1, b1);
       Puntos puntoB = new Puntos(a2, b2);
        Puntos puntoC = new Puntos(a3, b3);
        Puntos puntoD = new Puntos(a4, b4);
        areayperimetro = new Cuadrado(puntoC, puntoD, puntoA,puntoB);
        areayperimetro.hallarInformacion();
